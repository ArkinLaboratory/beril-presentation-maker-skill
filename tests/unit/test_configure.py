"""Unit tests for `beril_presentation_maker.commands.configure`.
...
from beril_presentation_maker.commands import configure, template_env
...
def test_has_skill_marker_detects_per_skill_line():
    assert configure.has_skill_marker("# --- beril-presentation-maker-skill (per-skill) ---\n")
...
def test_configure_parser_accepts_positional_beril_root():
    from beril_presentation_maker.cli import build_parser
