...
# Vendored from paper-writer per D-040; package path differs.
from beril_presentation_maker.skill.tools import extract_methods as em
...
class TestCLI:
    # Vendored from paper-writer per D-040; package path adapted.
    SCRIPT = (
        Path(__file__).resolve().parents[2]
        / "src"
        / "beril_presentation_maker"
        / "skill"
        / "tools"
        / "extract_methods.py"
    )
