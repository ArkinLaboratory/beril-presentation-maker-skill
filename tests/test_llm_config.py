...
from beril_presentation_maker import llm_config as lc
...
def test_old_style_env_upgrades_cleanly():
    ...
    `beril-presentation-maker configure` without touching .env first.
    """
    from beril_presentation_maker.commands import configure
