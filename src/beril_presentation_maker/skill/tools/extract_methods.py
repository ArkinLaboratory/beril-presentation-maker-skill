...
Vendored into beril-presentation-maker v0.4 per D-040 (2026-05-12) from
beril-paper-writer's M1 §C0 ship state (2026-05-07). Source-of-truth
upstream: spike/beril-paper-writer-skill-draft/src/beril_paper_writer/
skill/tools/extract_methods.py. Module body is byte-portable; this copy
adds only this attribution. SPEC §6.3 + D-018 references below refer to
paper-writer's spec; presentation-maker's V0_4_ARCHITECTURE.md §4.5
captures the cross-skill consumption contract.

Per paper-writer SPEC §6.3 + DECISIONS D-018: Methods grounding has two
complementary sources, both required:
