# Prompt suite skeleton — beril-presentation-maker

**Purpose.** This is the section structure that every prompt in
`prompts/*.v1.md` should follow. It exists so the 13 prompts share a
...
clarification): all 13 prompts in the suite nest the closing-message
...
9. **Length target.** Aim ≤500 lines. Citation_pool landed at 483.
...
it once all 13 prompts are drafted and reviewed.
