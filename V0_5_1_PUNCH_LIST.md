...
| A — restructure slide_compose.v3.md per D-075 (concat fix) | prompts + orchestrator dispatcher | ⬜ not started |
| A.1 — fix v3 overlay anti-pattern field names per D-077 | prompts | ⬜ not started |
| A.2 — restructure substory_design.v3.md per D-078 (same concat fix) | prompts + orchestrator dispatcher | ⬜ not started |
