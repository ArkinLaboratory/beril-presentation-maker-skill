...
| B — wire invariance into `revise_loop.py` (per-finding gate) | `revise_loop.py` edit | ⬜ not started |
| C — P3 retirement (rewrite as wrapper around `check_quantitative_grounding`) | `validate_presentation.py` + cascade `_P0_VALIDATORS` re-add P3 | ⬜ not started |
